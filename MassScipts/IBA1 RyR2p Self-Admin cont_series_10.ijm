...
run("Bio-Formats Importer", "open=[/home/u22/cgdeer/IBA1 RyR2p Self-Admin cont.lifext] autoscale color_mode=Default rois_import=[ROI manager] split_channels view=Hyperstack stack_order=XYCZT series_10");
...
saveAs("Results", "/home/u22/cgdeer/IBA1 RyR2p Self-Admin cont-Series_10_CellStats.csv");
rename("C0_IBA1 RyR2p Self-Admin cont_series_10_Largest_Isolate");

//Step 1 Phase 6 save out volume in ome.tif
//replace series number here
run("Bio-Formats Exporter", "save=[C0_IBA1 RyR2p Self-Admin cont_series_10.ome.tif] export compression=uncompressed");
run("Bio-Formats Exporter", "save=/home/u22/cgdeer/IBA1 RyR2p Self-Admin cont_series_10");

//Step 2 Phase 0 Isolate signal of a channel using the isolated volume of the cell of interest
//replace series number
imageCalculator("Subtract create stack", "IBA1 RyR2p Self-Admin cont.lifext - C=1","C0_IBA1 RyR2p Self-Admin cont_series_10_Largest_Isolate");
...
//replace series number
saveAs("Results", "/home/u22/cgdeer/IBA1 RyR2p Self-Admin cont_series_10.csv");
run("Bio-Formats Exporter", "save=/home/u22/cgdeer/IBA1 RyR2p Self-Admin cont_series_10.ome.tif export compression=Uncompressed");
